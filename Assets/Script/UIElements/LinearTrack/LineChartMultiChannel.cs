...
{  
    public LineChartMultiChannel(int _lineChartWidth, int _lineChartHeight, Image _image, LinearTrackMoving _moving, LinearTrackUIUpdate _ui_update) :base(_lineChartWidth, _lineChartHeight, _image){
